...
### A note about eventInfo

Use Case: You want to include information from the start of an API call to be transmitted to webhook.  This can be accomplished by updating the eventInfo object in the API call as below.

For example, in the User API, the API call might look as follows,
...
The above API call will result in the following be transmitted to the webhook event being sent out.
